...
#define SPLIT_LAYER_STATE_ENABLE // allow slave to get layer state info
#define SPLIT_MODS_ENABLE // allow slave to get layer state info
#define MASTER_LEFT
// #define MASTER_RIGHT
// #define EE_HANDS
...
#    define RGBLIGHT_SPLIT
    ...
    #define RGBLIGHT_EFFECT_STATIC_GRADIENTKC_LSFT
...
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_TAB),  LT(U_MOUSE,KC_ENT),LT(U_SYM,KC_SPC),  LT(U_NUM,KC_BSPC), LT(U_MEDIA,KC_NO),  U_NP,              U_NP
...
KC_3,              KC_A,              KC_S,              KC_D,              KC_F,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_QUOT),   \
KC_LSFT,           KC_Z,              KC_X,              KC_C,              KC_V,              KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    LT(U_BUTTON,KC_SLSH),\
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),KC_LCTL,  KC_SPC,LT(U_SYM,KC_SPC),  LT(U_NUM,KC_BSPC), TD(U_TD_U_BASE),  U_NP,              U_NP
